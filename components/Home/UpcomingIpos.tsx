          ...
          <div className="text-center sm:text-left">
            <h2 className="text-2xl md:text-3xl font-black text-gray-900 mb-2 flex flex-col items-center gap-2 sm:flex-row sm:items-center sm:gap-3 font-ibm-plex">
              <div className="flex items-center justify-center">
                <span className="text-[#00914D] font-bold text-2xl md:text-3xl animate-[slideRight_1.5s_ease-in-out_infinite]" style={{ animationDelay: '0s' }}>&gt;</span>
                <span className="text-[#00914D] font-bold text-2xl md:text-3xl animate-[slideRight_1.5s_ease-in-out_infinite] -ml-1" style={{ animationDelay: '0.2s' }}>&gt;</span>
                <span className="text-[#00914D] font-bold text-2xl md:text-3xl animate-[slideRight_1.5s_ease-in-out_infinite] -ml-1" style={{ animationDelay: '0.4s' }}>&gt;</span>
              </div>
              <div>
