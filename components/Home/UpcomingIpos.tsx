          ...
          <div className="text-left">
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-black text-gray-900 mb-2 flex items-start justify-center sm:justify-start gap-2 lg:gap-3 font-ibm-plex">
              <div className="flex items-center justify-center mt-4">
                <span
                  className="text-[#00914D] font-bold text-lg sm:text-xl lg:text-2xl animate-[slideRight_1.5s_ease-in-out_infinite]"
                  style={{ animationDelay: "0s" }}
                >
                  &gt;
                </span>
                <span
                  className="text-[#00914D] font-bold text-lg sm:text-xl lg:text-2xl animate-[slideRight_1.5s_ease-in-out_infinite] -ml-1"
