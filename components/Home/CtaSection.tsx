...
export function CtaSection() {
    return (
        <section className="py-10 sm:py-16 lg:py-24" style={{
            background: `
                        ...
                        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-black text-gray-900 mb-2 font-ibm-plex">
                            <div className="flex items-center justify-center sm:justify-start gap-2 lg:gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-gray-600 mt-2 text-sm sm:text-base font-medium font-ibm-plex">Get exclusive IPO insights, comprehensive market analysis, GMP updates, and investment opportunities delivered to your inbox weekly.</div>
                                </div>
                            </div>
                        </h2>
                    </div>
