    ...
    <div className="relative py-10">
      ...
      <div className="relative z-10">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-black text-gray-900 mb-2 font-ibm-plex">
                  <div className="flex items-center justify-center sm:justify-start gap-2 lg:gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600 mt-2 font-ibm-plex text-sm sm:text-base font-medium">
                        Get exclusive IPO insights, comprehensive market
                        analysis, GMP updates, and investment opportunities
        ...
        <footer className="py-1">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 lg:px-30">
            <h2
              className="text-2xl font-dm-serif text-gray-900 mb-2 text-center"
            ...
            <div className="text-center">
              <div className="w-full overflow-hidden text-center">
                <p
                  className="text-gray-600 font-ibm-plex"
