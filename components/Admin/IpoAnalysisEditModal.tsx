    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button
          ...
          className={
            hasExisting
              ? "h-9 px-3 text-sm font-bold border-primary/20 hover:bg-primary/10 text-primary"
              : "h-9 px-3 text-sm font-bold border-score-good/20 hover:bg-score-good/10 text-score-good"
          }
        >
      ...
      <DialogContent className="max-w-6xl h-[85vh] flex flex-col font-sans p-0 overflow-hidden rounded-xl bg-card shadow-2xl">
        ...
        <Tabs defaultValue="fundamentals" className="flex-1 flex flex-col overflow-hidden min-h-0">
          <TabsList className="px-6 border-b bg-muted/50 justify-start rounded-none h-12 flex-shrink-0 flex gap-4">
            ...
            <TabsContent value="verdict" className="space-y-6 m-0">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <Input type="number" min={1} max={10} value={summaryGains.allotment_score} onChange={(e) => setSummaryGains(prev => ({ ...prev, allotment_score: parseInt(e.target.value) || 0 }))} className="bg-card" />
                </div>
              </div>
              <div className="flex flex-col gap-1.5">
